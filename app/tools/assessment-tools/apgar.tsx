        ...
        <ScrollView contentContainerStyle={{ gap: 12, paddingBottom: 24 }}>
          ...
          <Card>
            ...
            >
              ...
              >
                {t("apgar_page_disclaimer")}
              </Text>
            </View>
          </Card>
          <Card>
            <Title>{t("tool_sources_title")}</Title>
            <Subtle>{t("apgar_sources_sub")}</Subtle>

            <View style={{ marginTop: 8 }}>
              <SourceItem
                title={t("apgar_source_1_title")}
                subtitle={t("apgar_source_1_sub")}
              />
              <SourceItem
                title={t("apgar_source_2_title")}
                subtitle={t("apgar_source_2_sub")}
              />
              <SourceItem
                title={t("apgar_source_3_title")}
                subtitle={t("apgar_source_3_sub")}
              />
            </View>
          </Card>
