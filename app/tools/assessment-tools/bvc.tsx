      ...
      <Screen>
        <ScrollView contentContainerStyle={{ gap: 12, paddingBottom: 24 }}>
          ...
          <CollapsibleCard
            ...
            subtitle={t("bvc_page_disclaimer")}
          >
            <View
              style={{
                borderRadius: 14,
          ...
          <CollapsibleCard
            ...
            subtitle={t("bvc_sources_sub")}
          >
            <Subtle style={{ marginBottom: 8 }}>{t("bvc_sources_sub")}</Subtle>

            <View style={{ marginTop: 4 }}>
              <SourceItem
                title={t("bvc_source_1_title")}
                subtitle={t("bvc_source_1_sub")}
              />
              <SourceItem
                title={t("bvc_source_2_title")}
                subtitle={t("bvc_source_2_sub")}
              />
              <SourceItem
                title={t("bvc_source_3_title")}
                subtitle={t("bvc_source_3_sub")}
              />
            </View>
          </CollapsibleCard>
        </ScrollView>
